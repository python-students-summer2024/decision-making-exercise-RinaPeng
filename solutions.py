...
def get_discount():
    ...
    """
    #### write your solution for this function below here. ####
    masks = int(input("Enter the number of masks you would like: "))
    cost_per_mask = 5
    total_cost = masks * cost_per_mask
    if masks >= 5000:
        total_cost *= 0.8  # applying 20% discount
    total_cost = round(total_cost)  # rounding to nearest integer
    return f"${total_cost:,}"
